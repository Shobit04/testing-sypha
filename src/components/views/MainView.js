...
export class MainView extends LitElement {
    ...
    render() {
        return html`
            <div class="welcome">Welcome to Local AI</div>

            <div class="description">
                This app uses Hugging Face Whisper for speech-to-text and Ollama Gemma 2B for AI responses.
                <br><br>
                You need:
                <br>• Hugging Face access token in .env file
                <br>• Ollama running locally with Gemma 2B model
                <br><br>
                <span @click=${this.handleAPIKeyHelpClick} class="link">Setup Guide</span>
            </div>
